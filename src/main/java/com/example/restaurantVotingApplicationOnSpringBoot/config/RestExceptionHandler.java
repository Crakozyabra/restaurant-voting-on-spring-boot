package com.example.restaurantVotingApplicationOnSpringBoot.config;

import com.example.restaurantVotingApplicationOnSpringBoot.error.*;
...
import static com.example.restaurantVotingApplicationOnSpringBoot.error.ErrorType.*;
